...
module.exports = {
  ...
  async execute(interaction) {
    const motiquote = await request(
      `https://kawaii.red/api/gif/coffee/token=anonymous`
    );
    ...
    const embed = new EmbedBuilder()
      ...
      .setTimestamp()
      .setThumbnail(
        "https://cdn.discordapp.com/avatars/1006680670480891965/52758b950932b7bfc46fc0849cecf8eb.png"
      )
      .setURL(support)
      .setFooter({
